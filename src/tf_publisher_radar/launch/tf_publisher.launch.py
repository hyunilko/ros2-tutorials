...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        # DeclareLaunchArgument("rviz_config", default_value=os.path.join(package_path, "rviz", "radar_lidar.rviz")),
        DeclareLaunchArgument("publish_tf", default_value='true'),
        DeclareLaunchArgument("urdf_model", default_value=os.path.join(package_path, "urdf", "multi_radars_each_pub.urdf")),
        # DeclareLaunchArgument("urdf_model", default_value=os.path.join(package_path, "urdf", "radar_lidar.urdf")),
    ]
